...
def main():
    ...
    input_fname = os.path.join(base_dir, f"{subject_id}_cropped_rereferenced_raw.fif")
    # Define the name for the output file of this script
    output_fname = os.path.join(base_dir, f"{subject_id}_cropped_ica_cleaned_raw.fif")
