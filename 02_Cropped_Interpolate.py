...
def main():
    ...
    input_fname = os.path.join(base_dir, f"{subject_id}_cropped_filtered_raw.fif")
    output_fname = os.path.join(base_dir, f"{subject_id}_cropped_interpolated_raw.fif")
    ...
    print("Done. You can now use this cropped .fif file for the next step.")
